    ...
    return (
        <section id="startup"> 
            ...
            <div class="flex flex-col text-center w-full mb-20">
                    ...
                    <br />
                    <p class="font-machina text-gray-800 text-lg lg:w-2/3 mx-auto leading-relaxed text-base">Refer us if you're participating in the Pioneer tournament, <a href="https://pioneer.app/join/utopia.so" class="underline text-red-500">here</a>.</p>
                </div>
                <div class="flex flex-wrap -mx-4 -mb-10 text-center justify-center">
                    <div class="sm:w-1/2 mb-10 px-4">
                        ...
                        <h2 class="title-font text-2xl font-medium text-black mt-6 mb-3 font-soehne">UTOPIA</h2>
                        <p class="leading-relaxed text-base text-lg font-machina">Your own customized web and mobile app, made to order. Includes integrated payments, appointments, e-commerce, live classes, student analytics and much more.</p>
