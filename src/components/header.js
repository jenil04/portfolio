...
function Header() {
  ...
  <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <div className="lg:w-2/5 inline-flex lg:justify-end ml-5 lg:ml-0">
      <a href="/contact"><button className="inline-flex items-center bg-gray-900 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 rounded-full text-base text-white font-machina mt-4 md:mt-0">Contact
