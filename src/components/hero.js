...
function Hero() {
    return (
        <section class="text-gray-700 body-font font-machina" style={{backgroundImage: `url(${bgr})`}}>
            <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                    ...
                    <div class="flex justify-center"> 
                        ...
                        <a href="https://jenil.substack.com"><button class="ml-4 inline-flex text-black bg-transparent border border-black py-2 px-6 focus:outline-none hover:bg-gray-800 hover:text-white rounded-full">Newsletter</button></a>
                    </div>
                </div>
