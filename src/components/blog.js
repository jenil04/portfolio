                        ...
                        <img className="object-cover object-center rounded" alt="blog" src={btc} style={{filter: "grayscale(100%)"}}/>
                            <div className="p-6">
                                ...
                                <div className="flex items-center flex-wrap ">
                                    <a href="https://jenil.substack.com/p/understanding-bitcoin" className="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0 font-machina">Learn More
                    ...
                    <div className="p-4 md:w-1/3">
                        ...
                        <img className="object-cover object-center rounded" alt="blog" src={ai} style={{filter: "grayscale(100%)"}}/>
                            <div className="p-6">
                                ...
                                <h1 className="title-font text-lg font-medium text-gray-900 mb-3 font-machina">Understanding GPT-3 by OpenAI</h1>
                                <p className="leading-relaxed mb-3 font-machina">It can understand a Series of Photos, Calculate Inflation Rates, and Tell Us What the Moon Looks Like.</p>
                                <div className="flex items-center flex-wrap">
                                    <a href="https://jenil.substack.com/p/understanding-gpt-3-by-openai" className="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0 font-machina">Learn More
                <svg className="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                            <path d="M5 12h14"></path>
                                            <path d="M12 5l7 7-7 7"></path>
                                        </svg>
