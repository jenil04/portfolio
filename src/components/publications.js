...
function Publications() {
    ...
    return (
        <section class="text-gray-700 body-font" id="pub" style={{backgroundImage: `url(${bgr})`}}>
            <div class="container px-5 py-24 mx-auto">
                <div class="flex flex-col text-center w-full mb-20">
                    <h2 class="text-xs text-black tracking-widest font-medium title-font mb-1 font-machina">Awards & Accolades</h2>
                    ...
                    <div class="p-4 md:w-1/3">
                        <div class="flex rounded-lg h-full p-8 flex-col" style={{boxShadow: "0 4px 8px 0 rgba(0,0,0,0.2)"}}>
                            ...
                            <div class="flex-grow">
                                ...
                                <a href="https://ieeexplore.ieee.org/document/8783004" class="mt-3 text-indigo-500 inline-flex items-center font-machina">Learn More
                    ...
                    <div class="p-4 md:w-1/3">
                        <div class="flex rounded-lg h-full p-8 flex-col" style={{boxShadow: "0 4px 8px 0 rgba(0,0,0,0.2)"}}>
                            ...
                            <div class="flex-grow">
                                ...
                                <a href="https://ieeexplore.ieee.org/document/9042998" class="mt-3 text-indigo-500 inline-flex items-center font-machina">Learn More
              <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
                                        <path d="M5 12h14M12 5l7 7-7 7"></path>
                                    </svg>
                                </a>
                    ...
                    <div class="p-4 md:w-1/3">
                        <div class="flex rounded-lg h-full p-8 flex-col" style={{boxShadow: "0 4px 8px 0 rgba(0,0,0,0.2)"}}>
                            ...
                            <div class="flex-grow">
                                <p class="leading-relaxed text-base font-machina">Published & Presented in ICCE 2020, under CES, Las Vegas, Nevada.</p>
                                <a href="https://ieeexplore.ieee.org/document/9043061" class="mt-3 text-indigo-500 inline-flex items-center font-machina">Learn More
              <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
                                        <path d="M5 12h14M12 5l7 7-7 7"></path>
                                    </svg>
                                </a>
