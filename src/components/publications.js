        ...
        <section class="text-gray-700 body-font" id="pub">
            <div class="container px-5 py-24 mx-auto">
                <div class="flex flex-col text-center w-full mb-20">
                    <h1 class="sm:text-3xl text-2xl font-medium title-font text-black font-soehne">Publications</h1>
                    <br />
                ...
                <div class="flex flex-wrap -m-4">
                    <div class="p-4 md:w-1/3">
                        <div class="flex rounded-lg h-full p-8 flex-col shadow-lg hover:shadow-xl"> 
                            <div class="flex items-center mb-3">
                                <h2 class="text-black text-lg title-font font-medium font-soehne">Token Reward Protocol on Ethereum</h2>
                            </div>
                            <div class="flex-grow">
              ...
              <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24"> 
                    ...
                    <div class="p-4 md:w-1/3">
                        <div class="flex rounded-lg h-full p-8 flex-col shadow-lg hover:shadow-xl">
                            <div class="flex items-center mb-3">
                                <h2 class="text-black text-lg title-font font-medium font-soehne">Secure Data Management for IoT using Ethereum</h2>
                            </div>
                            <div class="flex-grow">
              ...
              <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
                    ...
                    <div class="p-4 md:w-1/3">
                        <div class="flex rounded-lg h-full p-8 flex-col shadow-lg hover:shadow-xl">
                            <div class="flex items-center mb-3">
                                <h2 class="text-black text-lg title-font font-medium font-soehne">Resilient and Efficient Blockchain Consensus Protocol</h2>
                            </div>
                            <div class="flex-grow">
                                <p class="leading-relaxed text-base font-machina">Published & Presented in ICCE 2020, under CES, Las Vegas, Nevada.</p>
