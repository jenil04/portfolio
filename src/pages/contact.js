  ...
  return (
    <Layout>
      <SEO
        ...
        title="Contact"
      />
      <section class="text-gray-700 bg-gray-200 body-font" style={{backgroundImage: `url(${bg})`, backgroundSize: "cover"}}>
        <div class="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
          ...
          <div class="text-center lg:w-2/3 w-full">
            ...
            <div class="flex justify-center">
              <a href="mailto:jenilkthakker@gmail.com"><button class="inline-flex text-white hover:bg-white hover:text-black border border-black bg-black border-0 py-3 px-6 focus:outline-none shadow-lg rounded-full text-lg font-machina">Email me</button></a>
            </div>
          </div>
        </div>
      </section>
