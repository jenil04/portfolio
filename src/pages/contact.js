      ...
      <section class="text-gray-700 bg-gray-200 body-font" style={{backgroundImage: `url(${bg})`}}>
        <div class="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
          ...
          <div class="text-center lg:w-2/3 w-full">
            ...
            <p class="mb-8 leading-relaxed font-machina">Feel free to reach out to me for work opportunities or collab on a side-project. I'm also looking to build a team (founding engineer) for a startup I'm working on, so if you are based in India, please 
            ...
            <div class="flex justify-center">
              <button href="mailto:jenilkthakker@gmail.com" class="inline-flex text-white bg-black border-0 py-2 px-6 focus:outline-none hover:bg-gray-800 rounded-full text-lg font-machina">Email me</button>
            </div>
          </div>
        </div>
      </section>
