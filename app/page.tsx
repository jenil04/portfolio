  ...
  <div className="my-8">
    ...
    <li>Founder & CEO, Tokenfi Inc.</li>
        <ul className="list-disc list-inside ml-6 space-y-1 text-neutral-900 dark:text-neutral-200">
          <li>Building <a href='https://tokens.fun' className="text-neutral-600 dark:text-neutral-400 hover:underline" target="_blank" rel="noopener noreferrer">tokens.fun</a>: where anyone can launch their onchain startup.</li>
