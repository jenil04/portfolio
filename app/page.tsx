...
<section className="bg-white dark:bg-black text-neutral-900 dark:text-neutral-100">
  ...
  <div className="my-8">
    ...
    <ul className="list-disc list-inside space-y-2">
      <li>
        Founder and CEO at <a href="https://coinvise.co" target="_blank" rel="noopener noreferrer" className="text-neutral-600 dark:text-neutral-400 hover:underline">Coinvise</a>⸺create, trade & distribute goal-based tokens:
        <ul className="list-disc list-inside ml-6 space-y-1 text-neutral-900 dark:text-neutral-200">
          <li>Won Pioneer⸺an accelerator founded by <a href="https://dcgross.com/" target="_blank" rel="noopener noreferrer" className="text-neutral-600 dark:text-neutral-400 hover:underline">Daniel Gross</a> & <a href="https://x.com/narang_rishi" target="_blank" rel="noopener noreferrer" className="text-neutral-600 dark:text-neutral-400 hover:underline">Rishi Narang</a>.</li>
