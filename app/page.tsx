...
<section className="bg-white dark:bg-black text-neutral-900 dark:text-neutral-100">
  ...
  <div className="my-8">
    ...
    <ul className="list-disc list-inside space-y-2">
      <li>
        ...
        <ul className="list-disc list-inside ml-6 space-y-1 text-neutral-800 dark:text-neutral-200">
          ...
          <li>Highlights: <a href="https://x.com/CoinbaseWallet/status/1738232055341760996" target="_blank" rel="noopener noreferrer" className="text-neutral-600 dark:text-neutral-400 hover:underline">Base Spotlight</a>, Created <a href="https://www.coindesk.com/learn/what-is-desk-coindesks-social-token-explained/" target="_blank" rel="noopener noreferrer" className="text-neutral-600 dark:text-neutral-400 hover:underline">CoinDesk’s DESK token</a>, <a href="https://community.theblock.co/" target="_blank" rel="noopener noreferrer" className="text-neutral-600 dark:text-neutral-400 hover:underline">The Block’s Community Pass</a>.</li>
        </ul>
      </li>
      <li>Publications: <a href="https://ieeexplore.ieee.org/document/8783004" className="text-neutral-600 dark:text-neutral-400 hover:underline">Token locking reward model</a>, <a href="https://ieeexplore.ieee.org/document/9043061" className="text-neutral-600 dark:text-neutral-400 hover:underline">a threshold-based consensus algorithm</a> & <a href="https://ieeexplore.ieee.org/document/9042998" className="text-neutral-600 dark:text-neutral-400 hover:underline">secure data management for IoT devices</a>.</li>
    </ul>
  </div>
  ...
  <div className="my-8">
    ...
    <ul className="list-disc list-inside space-y-2">
      <li>How to Build at IIM, Ahmedabad, IIT Gandhinagar & <a href="https://x.com/iaruniversity/status/1834462359521222847" target="_blank" rel="noopener noreferrer" className="text-neutral-600 dark:text-neutral-400 hover:underline">IAR</a>.</li>
